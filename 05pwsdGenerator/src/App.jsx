...
//use ref is used when we want to take reference, useCallback is for optimization and useEffect is for re rendeing 
...
//we can take the reference of any element on the webpage using useRef and it has to be passed {line 59 and 14}
